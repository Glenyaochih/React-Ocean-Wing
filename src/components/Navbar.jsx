  ...
  return (
    ...
    <div className="bg-primary-300 d-flex flex-column " style={{ height: 78 }}>
            ...
            <div className="mt-auto">
              <img src="/public/images/header/wave-decoration.png" alt="" />
            </div>
          </div>
          ...
          <section className='product-change d-none d-lg-block'>
            <ul className='d-flex justify-content-center align-items-center h-100'>
              <li ><a className='h4 btn btn-lg' href="">長板</a></li>
              <li ><a className='h4 btn btn-lg' href="">短板</a></li>
              <li ><a className='h4 btn btn-lg' href="">配件</a></li>
            </ul>
          </section>
